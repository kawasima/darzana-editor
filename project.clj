(defproject net.unit8.darzana/darzana-editor "0.1.0-SNAPSHOT"
  :description "An editor for dazana"
  ...
  {:builds
   {:dev-main {:source-paths ["src/cljs/main"
                              "src/cljs/dev-main"]
               :figwheel {:on-jsload "darzana-editor.main.core/reload"}
               :compiler {:target :nodejs
                          :main "darzana-editor.main.core"
    ...
    :dev-front {:source-paths ["src/cljs/front"]
                :figwheel {:on-jsload "darzana-editor.core/reload"}
                :compiler {:main "darzana-editor.core"
